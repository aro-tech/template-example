 ...
 */
public class CompanyAssert extends AbstractAssert<CompanyAssert, Company>  implements org.example.assertions.generated.Assertions {
   ...
   */
   public AddressAssert address()  {
        // check that actual Company we want to make assertions on is not null.
        isNotNull();

        // return the assertion for the property
        return (AddressAssert) assertThat(actual.getAddress()).as("address");
   }
